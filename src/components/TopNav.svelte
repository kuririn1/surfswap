...
<nav class="p-4">
    ...
    <div class="flex flex-row">
        ...
        <div class="flex-none">
            ...
            {:else}
                <button on:click={login} class="bg-gradient-to-r from-indigo-500 to-indigo-400 hover:shadow-[0_0_22px_-7px_rgba(1,4,232,0.8)] hover:cursor-pointer rounded-lg text-white text-sm py-2 px-4">
                        Login with Deso
                </button>   
            {/if}
        </div>
